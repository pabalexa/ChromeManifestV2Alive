@echo off
:: Este script agrega una clave en el registro de Windows para habilitar el soporte de Manifest v2 en Microsoft Edge
...
:: La ruta especificada es para las políticas de Microsoft Edge en el registro
...
:: "HKLM\Software\Policies\Microsoft\Edge": Ruta del registro donde se agregará la política
...
echo Puedes verificar el cambio en edge://policy.
